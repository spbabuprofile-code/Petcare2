                ...
                >
                  <div className="bg-white rounded-xl shadow-lg p-8 h-48 flex flex-col items-center justify-center border border-gray-200">
                    <div className="h-24 w-full flex items-center justify-center mb-3">
                      ...
                      />
                      <div
                        className="hidden w-full h-full items-center justify-center bg-gradient-to-br from-blue-100 to-blue-50 rounded-lg"
                        style={{ display: 'none' }}
                      >
                        <span className="text-xl font-bold text-blue-600 text-center px-2">
                          {brand.name}
                        </span>
                      </div>
                    </div>
