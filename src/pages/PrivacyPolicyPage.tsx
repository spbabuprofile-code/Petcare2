    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-primary text-white py-12">
        <div className="section-container">
          ...
          <p className="text-xl">How we protect and use your personal information</p>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              V-Care Pet Polyclinic ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your personal information when you use our website, visit our clinics, or use our services.
            </p>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>Home address and delivery address</li>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">2.3 Medical Records</h3>
            <p className="text-gray-700">
              We maintain detailed medical records for your pets, including diagnoses, treatments, prescriptions, vaccination records, and test results. These records are essential for providing quality veterinary care.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li><strong>Service Delivery:</strong> Provide veterinary care, grooming services, and product deliveries</li>
              <li><strong>Appointment Management:</strong> Schedule, confirm, and remind you of appointments</li>
              <li><strong>Payment Processing:</strong> Process transactions and send receipts</li>
              <li><strong>Communication:</strong> Send service updates, vaccination reminders, and promotional offers</li>
              ...
              <li><strong>Safety and Security:</strong> Prevent fraud and protect our systems</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
              ...
              <li>Delivery partners for product shipments</li>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">4.2 Veterinary Network</h3>
            <p className="text-gray-700 mb-4">
              With your consent, we may share your pet's medical records with:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
              <li>Specialist veterinarians for referrals</li>
              <li>Emergency veterinary hospitals</li>
            ...
            <p className="text-gray-700">
              We may disclose information when required by law, such as responding to court orders, legal processes, or government requests, or to protect our rights and safety.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>Secure backup systems for medical records</li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li><strong>Marketing Cookies:</strong> Track effectiveness of our advertising</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mt-4">
              To exercise these rights, contact us at privacy@vcarepetpolyclinic.com
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">8. Medical Records Access</h2>
            <p className="text-gray-700 mb-4">
              As the pet owner, you have the right to:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Access your pet's complete medical records</li>
              <li>Request copies of medical records (processing fee may apply)</li>
              <li>Request transfer of records to another veterinary clinic</li>
              <li>Review and correct factual errors in medical records</li>
            </ul>
            <p className="text-gray-700 mt-4">
              Medical records are retained for a minimum of 7 years as per veterinary practice regulations.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>Maintain medical records for regulatory purposes</li>
            </ul>
            <p className="text-gray-700 mt-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Vaccination and health check-up reminders</li>
              <li>Promotional offers and discounts</li>
              <li>New service announcements</li>
              <li>Pet care tips and educational content</li>
              <li>Newsletter updates</li>
            </ul>
            <p className="text-gray-700 mt-4">
              You can opt-out of marketing communications at any time by clicking "unsubscribe" in our emails or contacting us directly. Note that you will still receive essential service-related communications.
            </p>
          </section>
